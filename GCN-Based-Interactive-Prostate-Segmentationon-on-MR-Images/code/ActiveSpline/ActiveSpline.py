...
def plot_spline_list(cps_list, img_name = ''):
    # plt.axis([-2, 2, -2, 2])
...
def plot_spline_for_debug():
    ...
    plot_spline_list(diff_iou_init, '')
    plot_spline_list(diff_iou_pred, '')
    plot_spline_list(first_pred, '')
    plot_spline_list(human_init, '')
    plot_spline_list(human_pred, '')
